...
create table Forun(
  ...
  Forun_name varchar(16) unique not null,
  Forun_description varchar(128)
);
insert into Forun(FID,Forun_name,Forun_description) values (11,'李毅吧',now(),'帝吧');
insert into Forun(FID,Forun_name,Forun_description) values (12,'英雄联盟吧',now(),'人在塔在');
